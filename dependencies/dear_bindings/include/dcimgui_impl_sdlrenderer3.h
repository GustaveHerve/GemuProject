...
#include "dcimgui.h"
    ...
    // (Advanced) Use e.g. if you need to precisely control the timing of texture updates (e.g. for staged rendering),
    // by setting ImDrawData::Textures = NULL to handle this manually.
    ...
    // ImGui_ImplSDLRenderer3_RenderDrawData() call. (Please open an issue if you feel you need access to more data)
