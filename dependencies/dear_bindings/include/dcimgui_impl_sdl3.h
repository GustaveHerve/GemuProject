...
#include "dcimgui.h"
    ...
    // Gamepad selection automatically starts in AutoFirst mode, picking first available SDL_Gamepad. You may override
    // this. When using manual mode, caller is responsible for opening/closing gamepad.
    typedef enum
    {
    ...
    CIMGUI_IMPL_API void cImGui_ImplSDL3_SetGamepadMode(
        ImGui_ImplSDL3_GamepadMode mode); // Implied manual_gamepads_array = nullptr, manual_gamepads_count = -1
    CIMGUI_IMPL_API void cImGui_ImplSDL3_SetGamepadModeEx(ImGui_ImplSDL3_GamepadMode mode,
